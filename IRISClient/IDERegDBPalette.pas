...
uses
  IDEMain, ComCtrls, ExtCtrls, Grids, DB,
  DBCtrls, DBGrids,
  ap_DB, ap_Grids, ap_DBGrids, ap_ComCtrls, ap_ExtCtrls,
  ap_DBCtrls, ap_Mask, ap_X2IrisQuery, X2IrisQuery;
...
begin
  ...
  begin
    ...
    try
      RegisterComponent('Data Access',     TDatasource,    'DB');
      RegisterComponent('Data Access',     TX2IrisQuery,    'DB');
    finally
